package mx.com.livestream.api.youtube.test;
...
import mx.com.livestream.api.youtube.authorize.Auth;
...
public class CreateBroadcast {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            broadcastSnippet.setScheduledStartTime(new DateTime("2017-10-17T10:50:00.000Z"));
            broadcastSnippet.setScheduledEndTime(new DateTime("2017-10-17T10:58:00.000Z"));
